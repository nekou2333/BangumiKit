...
public struct LegacySubjectMedium: Codable {
    /// 条目 ID
    ///
    /// Example: 12
    public var id: Int?
    ...
    public struct Images: Codable {
        ...
        public init(large: String? = nil, common: String? = nil, medium: String? = nil, small: String? = nil, grid: String? = nil) {
            self.large = large
            self.common = common
            self.medium = medium
            self.small = small
    ...
    public struct Rating: Codable {
        ...
        public init(total: Int? = nil, count: Count? = nil, score: Double? = nil) {
            self.total = total
            self.count = count
            self.score = score
        }
    ...
    public struct Collection: Codable {
        ...
        public init(wish: Int? = nil, collect: Int? = nil, doing: Int? = nil, onHold: Int? = nil, dropped: Int? = nil) {
            self.wish = wish
    ...
    public struct StaffItem: Codable {
        /// 现实人物
        ...
        public init(legacyPerson: LegacyPerson, roleName: String? = nil, jobs: [String]? = nil) {
