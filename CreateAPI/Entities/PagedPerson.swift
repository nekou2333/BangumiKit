...
/// Paged[Person]
public struct PagedPerson: Codable, Hashable {
    public var data: [Person]?
    public var limit: Int?
    public var offset: Int?
    public var total: Int?

    public init(data: [Person]? = nil, limit: Int? = nil, offset: Int? = nil, total: Int? = nil) {
        self.data = data
        self.limit = limit
        self.offset = offset
        self.total = total
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try values.decodeIfPresent([Person].self, forKey: "data")
