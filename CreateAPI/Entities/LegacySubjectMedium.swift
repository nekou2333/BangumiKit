...
public struct LegacySubjectMedium: Codable, Hashable, Identifiable {
    /// 放送开始日期
    ///
    /// Example: "2002-04-02"
    ...
    /// 角色信息
    public var crt: [CrtItem]?
    /// 制作人员信息
    public var staff: [StaffItem]?
    ...
    public struct CrtItem: Codable, Hashable {
        /// 虚拟角色
        public var legacyCharacter: LegacyCharacter
        /// 角色类型
        ///
        /// Example: "主角"
        public var roleName: String?

        public init(legacyCharacter: LegacyCharacter, roleName: String? = nil) {
            self.legacyCharacter = legacyCharacter
            self.roleName = roleName
        }

        public init(from decoder: Decoder) throws {
            let values = try decoder.container(keyedBy: StringCodingKey.self)
            self.legacyCharacter = try LegacyCharacter(from: decoder)
            self.roleName = try values.decodeIfPresent(String.self, forKey: "role_name")
        }

        public func encode(to encoder: Encoder) throws {
            var values = encoder.container(keyedBy: StringCodingKey.self)
            try values.encode(legacyCharacter, forKey: "legacyCharacter")
            try values.encodeIfPresent(roleName, forKey: "role_name")
        }
    }

    public struct StaffItem: Codable, Hashable {
        /// 现实人物
        public var legacyPerson: LegacyPerson
        /// 职位
        ...
        public init(legacyPerson: LegacyPerson, jobs: [String]? = nil, roleName: String? = nil) {
            self.legacyPerson = legacyPerson
            self.jobs = jobs
            self.roleName = roleName
        }
        ...
        public init(from decoder: Decoder) throws {
            let values = try decoder.container(keyedBy: StringCodingKey.self)
            self.legacyPerson = try LegacyPerson(from: decoder)
            self.jobs = try values.decodeIfPresent([String].self, forKey: "jobs")
            self.roleName = try values.decodeIfPresent(String.self, forKey: "role_name")
        }

        public func encode(to encoder: Encoder) throws {
            var values = encoder.container(keyedBy: StringCodingKey.self)
            try values.encode(legacyPerson, forKey: "legacyPerson")
            try values.encodeIfPresent(jobs, forKey: "jobs")
            try values.encodeIfPresent(roleName, forKey: "role_name")
        }
    }

    public init(airDate: String? = nil, airWeekday: Int? = nil, collection: Collection? = nil, eps: Int? = nil, epsCount: Int? = nil, id: Int? = nil, images: Images? = nil, name: String? = nil, nameCn: String? = nil, rank: Int? = nil, rating: Rating? = nil, summary: String? = nil, type: Int? = nil, url: String? = nil, crt: [CrtItem]? = nil, staff: [StaffItem]? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.crt = try values.decodeIfPresent([CrtItem].self, forKey: "crt")
        self.staff = try values.decodeIfPresent([StaffItem].self, forKey: "staff")
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encodeIfPresent(crt, forKey: "crt")
