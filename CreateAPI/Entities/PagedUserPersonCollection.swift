...
public struct PagedUserPersonCollection: Codable, Hashable {
    public var data: [UserPersonCollection]?
    public var limit: Int?
    public var offset: Int?
    public var total: Int?

    public init(data: [UserPersonCollection]? = nil, limit: Int? = nil, offset: Int? = nil, total: Int? = nil) {
        self.data = data
        self.limit = limit
        self.offset = offset
        self.total = total
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try values.decodeIfPresent([UserPersonCollection].self, forKey: "data")
